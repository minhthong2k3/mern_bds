  ...
  return (
    <div>
      ...
      <form onSubmit={handleSummit}>
        ...
        <button disabled={loading} className='bg-blue-900 text-white px-4 py-2 rounded-md w-full max-w-md block mx-auto my-3 uppercase hover:bg-blue-900 disabled:bg-blue-300'>{loading ? 'Loading...' : 'Sign Up'}</button>
        <OAuth/> 
      </form>
